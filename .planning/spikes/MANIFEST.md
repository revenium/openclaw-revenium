...
|---|------|------|-----------|---------|------|
| 001 | nemoclaw-bootstrap | standard | Given a clean host, when NemoClaw `install.sh` runs, then NemoClaw + OpenShell come up and an OpenClaw agent completes one turn | **INVALIDATED** (on this host — macOS; needs Linux+Docker) | infra, install, nemoclaw, openshell |
