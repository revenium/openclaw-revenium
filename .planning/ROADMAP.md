...
- [ ] **Phase 5: Job Declaration Foundation** - Agent declares jobs via validated `kind:"job"` markers backed by an 11-label job taxonomy
...
| 5. Job Declaration Foundation | v1.1 | 2/3 | In Progress|  |
