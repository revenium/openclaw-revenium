...
- [ ] 04-01-PLAN.md — Foundation: task-taxonomy.json + common.sh constants/resolver wrapper + get-root-session-id.py + test harness
...
| 4. Task Metering & Attribution | 0/4 | Planned | - |
