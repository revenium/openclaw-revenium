...
---
*Last updated: 2026-06-11 — v1.4 NemoClaw/OpenShell Support shipped (Phases 12–16 complete). Phase 16 (Skill Deploy & Docs) deploys the skill via `nemoclaw skill install` behind a SKILL.md guard + hardened D-02 `✓ ready` assertion and ships the `docs/nemoclaw-setup.md` operator runbook; SC1+SC2 validated live on 34.224.27.67 and approved at a blocking human checkpoint (NCDEPLOY-01/02).*
