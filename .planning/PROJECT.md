...
---
*Last updated: 2026-06-08 — v1.4 Phase 13 (Sandbox Provisioning — Egress, CLI & Authenticated Metering) complete: two-preset egress + sha256-pinned CLI delivery + config-file creds + ledger-gated authenticated meter probe, validated live (HTTP 2xx) on 34.224.27.67, spike 003 VALIDATED, NCEGRESS-01/NCCLI-01/NCCLI-02 satisfied.*
